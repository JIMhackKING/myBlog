...
<div id="layout" style="padding-left: 0px;">
    <div id="main">
        ...
        <h2 class="content-subhead">更新预告</h2>
            <p>
            &nbsp;&nbsp;打造强大的后台管理系统，实现网站一站式管理；博客主页实现注册功能，并显示登录信息，以及实现发布新博客，修改博客，浏览曾经发布的文章等功能；登录页面实现记住密码功能，增加帮助信息（ToolTip）；以模板形式处理博客主页以及后台管理系统，使网页能够通过后端传递的信息作出相应的变化，减少修改网页时过多的冗杂操作，以达到最简单的网站管理和网页自动化处理。
            </p>
            <hr>
      <div class="pure-g">
